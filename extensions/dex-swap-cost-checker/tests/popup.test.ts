...
const EXPECTED_LINK = 'https://pigfox.com/?utm_source=dex-swap-cost-checker&utm_medium=browser-extension';

function expectPopup(root: HTMLElement): void {
  expect(root.querySelector('h1')?.textContent).toBe('DEX Swap Cost Checker — by Pigfox');
