...
const EXPECTED_LINK = 'https://pigfox.com/?utm_source=contract-safety-check&utm_medium=browser-extension';

function expectPopup(root: HTMLElement): void {
  expect(root.querySelector('h1')?.textContent).toBe('Contract Safety Check — by Pigfox');
