...
const EXPECTED_LINK = 'https://pigfox.com/?utm_source=ghost-job-detector&utm_medium=browser-extension';

function expectPopup(root: HTMLElement): void {
  expect(root.querySelector('h1')?.textContent).toBe('Ghost Job Detector — by Pigfox');
